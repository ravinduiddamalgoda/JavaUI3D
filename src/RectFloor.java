...
public class RectFloor extends JFrame implements GLEventListener, MouseListener, MouseMotionListener {
    ...
    public RectFloor(float tableScale , float chairScale , float cupboardScale , String tableColor , String chairColor , String cupColor , int floorMarginX , int floorMarginY , String floorColor)  {
        ...
        setTitle("Rectangle Floor Renderer");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            RectFloor renderer = new RectFloor(1 , 1 , 5 , "red" , "brown" , "blue" , 75 , 160 , "Tan");
    ...
    public void mouseDragged(MouseEvent e) {
        ...
        if (isDraggingChair) {
            ...
            if(x <= floorMarginX + 105 || x >=  windowWidth - (floorMarginY + 90) ){
                chairX = chairX;
            }else {
                chairX += x - prevX;
            }
...
//                chairX += x - prevX;
//            }
            if(y >= windowHeight - (floorMarginX + 140) || y<=  (floorMarginY + 140)){
                chairY = chairY;
            }
            else{
                chairY += y - prevY;
